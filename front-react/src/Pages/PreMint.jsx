...
const PreMint = () => {
  ...
  const PRIVATE_KEY =
    "045be0b52044ba0f842dea76a18ef921009a629e7c8ad114a51023c6acf50520";
  const SECRET_KEY =
    "dd0cZsTqYO9v8PJdRO8uuikrKvi6SpZKYbNdIqvn-d2-Df1QXTb9PUXUOJfO4OcJg9EUP3zQbx3jLJR1raQY9w";
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-between">
            <BorderButton
              className="text-lg"
              size="sm"
              onClick={handleAddNewCollectionProperty}
            >
              {t("submit")}
            </BorderButton>
          </div>
