          ...
          <div className="font-b4">
            <div className="w-full flex items-center justify-center md:flex-col gap-4 ">
              <div className="relative group items-center flex justify-center w-1/2" id="exhibitionImage">
                <img alt="" src={profileImageUrl ? profileImageUrl : `${"https://api.artina.org/static/images/No_Image_Available_SrUxrax.png"}`} className="pointer-events-none rounded-2xl max-w-md overflow-hidden object-cover h-auto flex-shrink-0 w-full" />
