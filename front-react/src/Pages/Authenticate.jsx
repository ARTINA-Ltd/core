      ...
      <div>
        {user ? (
          <div className="shadow-md">
            <div className={` ${'bg-[#f9f9f9] bg-[length:300px] bg-[url("https://artina.org/12.png")] '}   overflow-hidden pb-8`}>
              <div className="w-[90vw] mx-auto">
                <div className="lg:block  flex gap-10" style={{ justifyContent: "space-around" }}>
                  <div className=" bg-white rounded-3xl shadow-md p-10 flex gap-8 flex-wrap w-[70%] lg:w-full items-center h-full min-h-[70vh]">
                    <div className="flex sm:block">
                      <img src={user.user_profile.profile_picture ? user.user_profile.profile_picture : Avatar} alt="profilePicture" className="w-72 h-72 mb-8 self-start ml-8 rounded-full shadow-xl" />
                      <div className="flex flex-wrap gap-4 w-full">
                        <div className=" w-full flex  justify-center items-end gap-5 mb-4">
                          <SimpleInput className="shadow-lg" type="text" title="نام" defaultValue={user.user_profile.first_name} disabled={true} />
                          <SimpleInput className="shadow-lg" type="text" title=" نام خانوادگی" defaultValue={user.user_profile.last_name} disabled={true} />
                        </div>
                        <SimpleInput className="shadow-lg h-10" type="email" title=" ایمیل" defaultValue={user.user_profile.email} disabled={true} />
                      </div>
                    </div>
                    <div className="w-full flex gap-4">
                      <SimpleInput className="shadow-lg" type="number" title="کد ملی" defaultValue={user.user_profile.national_code} disabled={true} />
                      <SimpleInput className="shadow-lg" type="text" title="تاریخ تولد" defaultValue={user.user_profile.birthdate} disabled={true} />
                    </div>
                    <div className="flex gap-8 item ml-16 mr-auto">
                      <BorderButton onClick={() => document.getElementById("submit").showModal()}>تایید</BorderButton>
                      <BorderButton
                        onClick={() => {
                  ...
                  <div className="flex flex-col w-[25%] lg:w-full">
                    <div className="lg:mt-4 w-full bg-white rounded-lg p-1 flex items-center justify-center    ">
                      <img onClick={() => document.getElementById("my_modal_1").showModal()} src={user.user_profile.national_card_picture} alt="" className="z-20 object-cover block border-4 border-indigo-500 shadow-lg rounded-3xl lg:mt-5  " />
                    </div>
            ...
            <dialog id="my_modal_1" className="modal">
              <div className="modal-box bg-white">
                ...
                <img src={user.user_profile.national_card_picture} alt="" className="shadow-md rounded-md" />
                ...
                <div className="flex justify-center gap-4">
                  <form method="dialog">
                    <button className="mx-auto block ">
                      <BorderButton className="w-full mx-auto font-bold shadow-md" onClick={hanleApprove}>
                        ثبت
                      </BorderButton>
                    </button>
                  </form>
            ...
            <dialog id="reject" className="modal">
              <div className="modal-box bg-white">
                ...
                <div className="flex justify-center gap-4">
                  <form method="dialog">
                    <button className="mx-auto block ">
                      <BorderButton className="w-full mx-auto font-bold shadow-md" onClick={handleReject}>
                        ثبت
                      </BorderButton>
                    </button>
                  </form>
