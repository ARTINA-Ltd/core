            ...
            item.id == id ? (
              <TestLayout key={item.id}>
                <div className="flex gap-16">
                  <SimpleCard id="RightSide" className="bg-[#4e45d0] w-[45%] flex flex-col relative gap-12 items-center ">
                    <div className="flex flex-col gap-5">
                      <img src="https://maaidanoor.com/wp-content/uploads/2020/03/IMG_3933-1.jpg" className="rounded-xl"></img>
                  ...
                  <SimpleCard id="LeftSide" className={"flex flex-col gap-12 bg-base-100 w-full"}>
                    ...
                    <div className="relative flex items-center">
                      <div className="absolute text-[16px] opacity-40">تاریخ ساخت</div>
                    ...
                    <div className="relative flex items-center justify-self-end bg-[#f1f2f7] px-10 py-4 rounded-xl">
                      ...
                      <div className="text-[22px] mx-auto">{item.last_price} اتریوم</div>
                    </div>
                  </SimpleCard>
                </div>
                <div>
                  <SimpleCard className="bg-base-100 w-full flex flex-col relative gap-12 items-center mt-12">
                  ...
                  <SimpleCard className="bg-[#4e45d0] w-full flex flex-col relative gap-12 items-center mt-12">
                    <div className="flex items-center pt-3">
                      <div className="text-[32px] mx-auto text-white">قیمت پیشنهادی</div>
                    </div>
                    <Activity />
                  </SimpleCard>
                  <SimpleCard className="bg-base w-full flex flex-col relative gap-12 items-center mt-12">
                    <div className="flex items-center pt-3">
