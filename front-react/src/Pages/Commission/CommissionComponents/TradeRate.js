...
export default function TradeRate() {
  ...
  return (
    <div className="m-8 sm:m-2 sm:text-[14px] bg-base-200 rounded-md overflow-hidden">
      <table className="w-full">
        <thead>
          <tr>
            <th className="py-2 px-4 bg-primary text-primary-content">{t("table1.h1")}</th>
            <th className="py-2 px-4 bg-primary text-primary-content">{t("table1.h2")}</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="py-2 px-4 bg-secondary text-secondary-content">{t("table1.r1")}</td>
