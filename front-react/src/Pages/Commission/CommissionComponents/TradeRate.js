    ...
    <div>
      <div className="grid m-8">
        ...
        <div className="Row2 grid flex col-12">
          <div className="col1 col-6">0.35%</div>
          <div className="col2 col-6">کمتر از 10 میلیون تومان</div>
        </div>

        <div className="Row3 grid flex col-12">
          <div className="col1 col-6">0.3%</div>
          <div className="col2 col-6">ین 10 تا 50 میلیون تومان</div>
        </div>

        <div className="Row4 grid flex col-12">
          <div className="col1 col-6">0.25%</div>
        ...
        <div className="Row5 grid flex col-12">
          <div className="col1 col-6">0.2%</div>
          <div className="col2 col-6">
