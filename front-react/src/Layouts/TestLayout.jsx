...
const TestLayout = ({ children, connectWallet, className, wfull = false, rev = false }) => {
  return (
    <div style={{ direction: i18next.dir() }} className={`${rev ? 'bg-[#f9f9f9] bg-cover bg-[url("https://artina.org/6.jpg")] ' : 'bg-[#f9f9f9] bg-[length:300px] bg-[url("https://artina.org/12.png")] '}   overflow-hidden`}>
