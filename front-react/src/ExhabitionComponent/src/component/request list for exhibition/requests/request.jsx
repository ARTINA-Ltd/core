    ...
    <div className="section requests">
      ...
      <div className="state-box">
        <select value={state} onChange={(e) => setState(e.target.value)}>
          <option className="dropdown-content" disabled value="default">
            انتخاب کنید
          </option>
          ...
          <div className="request-box">
            <div className="request-content">
              <div className="artist-info">
                <img className="atrist-pro-pic" src={request.owner.image} />
                <div className="artist-secondary-info">
                  <p className="request-artist-name">
                    {request.owner.username}
                  </p>
                  <p className="request-rate"> ⭐️امتیاز({request.rate}) </p>
                  <p className="request-commission">
                    کمسیون:{request.commission}
                  </p>
                  <p className="request-nft-num">
                    تعداد ان اف تی ها:{request.nfts.length}
                  </p>
