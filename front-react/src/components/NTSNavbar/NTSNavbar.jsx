...
const NTSNavbar = () => {
  return (
    <div className="h-32 p-4 bg-base-300">
      <div className="w-[80vw] mx-auto flex justify-between">
        <div className="flex gap8 h-fit my-auto items-center">
          <FaUserAlt className="w-20 h-16" />
          <h1 className="text-5xl">My points:</h1>
          <h2 className="text-5xl">130</h2>
        </div>
        <div className="flex gap-4">
          <div className="bg-base-100 w-32 text-center h-20 roundedmd p-2">My games</div>
