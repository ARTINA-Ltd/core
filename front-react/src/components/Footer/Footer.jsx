...
const Footer = () => {
  ...
  const icons = {
    instagram: (
      <svg xmlns="http://www.w3.org/2000/svg" width="1.75em" fill="#ffffff" viewBox="0 0 24 24">
    ...
    telegram: (
      <svg xmlns="http://www.w3.org/2000/svg" width="1.75em" fill="#ffffff" viewBox="0 0 24 24" fillRule="evenodd">
  ...
  return (
    <div className="w-full bg-[#4e45d0] text-white py-4">
      ...
      <div className="w-full flex items-center justify-center gap-3 mt-3">
        <div className="bg-indigo-500 rounded-md p-2 cursor-pointer" onClick={() => window.open("https://instagram.com/artinanft?igshid=MzNlNGNkZWQ4Mg==")}>
          {icons.instagram}
        </div>
        <div className="bg-indigo-500 rounded-md p-2 cursor-pointer" onClick={() => window.open("https://t.me/artinanft")}>
          {icons.telegram}
        </div>
        <div className="bg-indigo-500 rounded-md p-2 cursor-pointer" onClick={() => window.open("https://twitter.com/artina_nft?t=19-DEqjd_wl8kLxETYPZXg&s=09")}>
          {icons.twitter}
        </div>
        <div className="bg-indigo-500 rounded-md p-2 cursor-pointer" onClick={() => window.open("https://www.linkedin.com/in/artina-nft-a8a66427a")}>
          {icons.linkedin}
        </div>
        <div className="bg-indigo-500 rounded-md p-2 cursor-pointer" onClick={() => window.open("https://discord.gg/6vXcZ2vZ")}>
          {icons.discord}
        </div>
      </div>
      <div className="bg-gradient-to-r mt-3 from-slate-50 to-slate-200 bg-clip-text text-transparent mx-auto text-center">Copyright ©2023 by Artina - All rights reserved</div>
    </div>
  );
};
