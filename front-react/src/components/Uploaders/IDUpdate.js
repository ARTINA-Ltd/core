...
import Image from "../../ProfilePage/IDImage";
...
export default function IDUpdate() {
    ...
    const itemTemplate = (file, props) => {
        return (
            <div className="flex align-items-center flex-wrap" style={{direction:'ltr'}}>
    ...
    const emptyTemplate = () => {
        return (
            <div className="flex align-items-center flex-column">
                ...
                <p className='font text-3xl'>لطفا عکس کارت ملی خود را اینجا بارگذاری بکنید</p>
               
                <i class="pi pi-id-card mt-3 p-5" style={{ fontSize: '18em', borderRadius: '80%', backgroundColor: 'var(--surface-b)', color: 'var(--surface-d)' }}></i>
    ...
    return (
        <div className='mt-8' style={{borderColor:'#424874' ,borderWidth:'2px',borderRadius:'9px', }}>
