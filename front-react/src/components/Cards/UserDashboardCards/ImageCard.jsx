...
const ImageCard = ({
  ...
  return (
    <div className={className}>
      <div
        className="relative transition-all cursor-pointer h-3/4 mb-10"
        onClick={onClick}
      >
        <img
          src={src}
          className="w-full rounded-lg object-cover p-2 h-full"
          alt=""
        />
      </div>
      <div>
            ...
            <div className="flex justify-between items-center">
              ...
              {showSell && (
                <div className="flex items-center gap-2">
                  <div
                    className="transition-all py-2 rounded-lg px-2 hover:bg-neutral cursor-pointer duration-75 relative"
            ...
            <div className="flex justify-between pb-8 items-center">
              ...
              {showSell ? (
                <div className="flex items-end gap-2">
                  <div
                    className="transition-all py-2 rounded-lg px-2 hover:bg-neutral cursor-pointer duration-75"
                    onClick={isVisible ? handleClickHide : handleClickShow}
                    onMouseOver={handleMouseOver}
                    onMouseMove={handleMouseMove}
                    onMouseOut={handleMouseOut}
                ...
                showCancel && (
                  <BorderButton onClick={handleCancel}>
                    {t("cancelSell")}
                  </BorderButton>
                )
              )}
            ...
            {showSell && (
              <div class="collapse collapse-arrow overflow-visible">
                ...
                <div class="collapse-title text-xl sm:w-[75%]  font-medium m-0 ">
                  <BorderButton className={"font-bold w-20 mx-auto"}>
