...
const MostFrequentQuestions = ({ className = "" }) => {
    return (
        <div className={`${className} flex justify-center bg-indigo-200 mt-10 lg:my-10`}>
            <div className="w-11/12 flex flex-col items-center text-black">
                <div className="font-b9 text-[40px] mt-10 sm:text-[30px]">
                    سوالات متداول
                </div>

                <div className="flex-col w-full">
                    <div className="flex justify-between mt-5">
                        <div className="w-6/12 mx-8 my-5 border-dotted border-2 border-indigo-500 rounded-3xl px-5">
