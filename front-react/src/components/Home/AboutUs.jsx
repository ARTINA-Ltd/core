...
const AboutUs = ({ className }) => {
  ...
  return (
    <div className={`${className}  w-full flex justify-center bg-primary text-primary-content py-16 relative overflow-hidden`}>
      ...
      <div className={`w-2/3 flex flex-col items-center sm:w-4/5`}>
        ...
        <div className="font-b2 text-[22px] text-center sm:text-[17px]">{t("aboutUsDescription")}</div>
      </div>
    </div>
  );
};
