...
const BorderButton = ({
  ...
  return (
    ...
    // </div>
    <div
      className={`text-[14px] bg-[#0000aa08] border-[1px] border-[#4e45d0] ${disabled
        ? "opacity-40 cursor-default"
        : "cursor-pointer"} py-2 pl-10 pr-6 rounded-lg transition-all hover:pr-8 hover:pl-8 hover:bg-[#0000aa11] relative group overflow-hidden ${className} duration-75`}
      onClick={onClick}
    >
      <img
        src="/13.png"
