...
const UploadItem = () => {
  ...
  return (
    <div>
      ...
      {isUploaded ? (
        <SimpleCard className={"bg-green-50 mt-12 flex gap-4 md:flex-col justify-center items-center"}>
          ...
          <div className="md:w-full flex items-center justify-center sm:text-sm sm:flex-col sm:text-center">
            <span className="text-green-600">
              {t("successfullyMinted-1")}
              <span className="text-green-600 bg-green-200 mx-1 p-0.5 sm:p-0 sm:px-0.5 rounded-md">
                {" "}{t("successfullyMinted-2")}{" "}
              </span>
              {" "}{t("successfullyMinted-3")}
            </span>
          </div>
