...
const FlowComponent = () => {
  ...
  return (
    <div className=" w-[80vw]  mx-auto my-12  " style={{ direction: "ltr" }}>
      <div className="flex justify-center items-center ml-[10.75rem]">
      <div className="z-[7]">
      <div className="w-fit text-5xl text-primary-content rounded-full bg-primary p-2 mx-auto"><RiGuideFill/></div>
        ...
        <div className="z-[6] -translate-x-7 " >
        ...
        <div className="z-[5] -translate-x-14">
        ...
        <div className="z-[4] -translate-x-[5.25rem]">
        ...
        <div className="z-[3] -translate-x-[7.25rem]">
        ...
        <div className="z-[2] -translate-x-[9rem]">
        ...
        <div className="-translate-x-[10.75rem]">
