...
const FlowComponent = () => {
  return (
    <div className=" w-[80vw] mx-auto text-center my-12" style={{ direction: "ltr" }}>
      <div className=" justify-center  items-center ml-[10.75rem]">
        <div className="flex justify-center items-center">
          <div className="my-4 z-[7]">
            ...
            <div className="flex justify-center items-center ">
              <div className="w-56 text-center lg:w-36 lg:text-xs md:w-24 md:text-[9px] sm:w-20  h-10 bg-primary flex justify-center text-primary-content items-center">
          ...
          <div className="my-4 z-[6] -translate-x-7 ">
            ...
            <div className="flex justify-center items-center ">
              <div className="w-56 text-center lg:w-36 lg:text-xs md:w-24 md:text-[9px]sm:w-20  h-10 bg-secondary flex justify-center items-center">
                <p className="w-fit text-black z-50">Create NFT</p>
              </div>
          ...
          <div className="my-4 z-[5] -translate-x-14">
            ...
            <div className="flex justify-center items-center  ">
              <div className="w-56 text-center lg:w-36 lg:text-xs md:w-24 sm:w-20  h-10 bg-accent flex justify-center items-center">
                <p className="w-fit text-accent-content z-50">Artina'n NFT Mint</p>
              </div>
          ...
          <div className="my-4 z-[4] -translate-x-[5.25rem]">
            ...
            <div className="flex justify-center items-center  ">
              <div className="w-56 text-center lg:w-36 lg:text-xs md:w-24 md:text-[9px]sm:w-20  h-10 bg-[#1967D2] flex justify-center items-center">
        ...
        <div className="flex mx-auto items-center justify-center ml-[10rem]">
          <div className="my-4 z-[3] -translate-x-[7.25rem]">
            ...
            <div className="flex justify-center items-center ">
              <div className="w-56 text-center lg:w-36 lg:text-xs md:w-24 md:text-[9px]sm:w-20  h-10 bg-[#FEB372] flex justify-center items-center">
          ...
          <div className="my-4 z-[2] -translate-x-[9rem]">
            ...
            <div className="flex justify-center items-center  ">
              <div className="w-56 text-center lg:w-36 lg:text-xs md:w-24 md:text-[9px]sm:w-20  h-10 bg-[#619BB2] flex justify-center items-center">
          ...
          <div className="my-4 -translate-x-[10.75rem]">
            ...
            <div className="flex justify-center items-center z-[1]  ">
              <div className="w-56 text-center lg:w-36 lg:text-xs md:w-24 md:text-[9px]sm:w-20  h-10 bg-[#6D0474] flex justify-center items-center">
