...
const PaperRockScissorsFriend = (props) => {
  const { gameId, className, opChoice, result: initialResult, opProfile, opUsername, choice } = props;
  ...
  return (
    <div className={`md:w-full mx-auto rounded-lg neon-border p-12 lg:text-sm ${className}`}>
      ...
      <div className="mx-auto grid gap-8 grid-cols-3 text-center justify-between my-12 text-3xl">
        <div className="">
          ...
          <div className="neon-border hover:text-black aspect-square text-center flex justify-center items-center hover:bg-secondary cursor-pointer lg:text-sm z-50 ease-out duration-200 rounded-xl p-2">{userChoice === "" ? "waiting for you" : userChoice === "paper" ? <img src={paper} alt="Paper" className="sm:w-32 z-[10] object-cover" /> : userChoice === "rock" ? <img src={rock} alt="Rock" className="sm:w-24 sm:h-24 object-cover" /> : <img src={scissors} alt="Scissors" className="sm:w-32 object-cover" />}</div>
        </div>
        <div className="">
        ...
        <div className="">
          ...
          <div className="neon-border hover:text-black lg:text-sm text-center aspect-square flex justify-center items-center hover:bg-secondary cursor-pointer z-50 ease-out duration-200 rounded-xl p-2">{opChoice === null ? "waiting for Opponent" : opChoice === "paper" ? <img src={paper} alt="Paper" className="sm:w-32 z-[10] object-cover" /> : opChoice === "rock" ? <img src={rock} alt="Rock" className="sm:w-24 sm:h-24 object-cover" /> : <img src={scissors} alt="Scissors" className="sm:w-32 object-cover" />}</div>
        </div>
      </div>
