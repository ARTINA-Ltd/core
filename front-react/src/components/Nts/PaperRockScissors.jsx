...
const PaperRockScissors = ({ onChoice }) => {
    ...
    <div className="w-1/2 lg:w-full mx-auto bg-base-200 rounded-lg p-12">
      <div className="mx-auto flex text-center justify-between my-12 text-3xl">
        <div>
          ...
          <div className="neon-border text-center w-44 h-44 flex justify-center items-center hover:bg-secondary cursor-pointer z-50 ease-out duration-200 rounded-xl p-2">{userChoice === "" ? "waiting for you" : userChoice === "paper" ? <img src={paper} alt="Paper" className="sm:w-32 z-[10] object-cover" /> : userChoice === "rock" ? <img src={rock} alt="Rock" className="sm:w-24 sm:h-24 object-cover" /> : <img src={scissors} alt="Scissors" className="sm:w-32 object-cover" />}</div>
        </div>
        <div>
          <p className="w-fit mx-auto py-8">Status</p>
          <div className="neon-border  text-center w-44 h-20 flex justify-center items-center hover:bg-secondary cursor-pointer z-50 ease-out duration-200 rounded-xl p-2">Pending</div>
        </div>
        <div>
          <p className="py-8">Opponent</p>
          <div className="neon-border  text-center w-44 h-44 flex justify-center items-center hover:bg-secondary cursor-pointer z-50 ease-out duration-200 rounded-xl p-2"></div>
        </div>
      </div>
