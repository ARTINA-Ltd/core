          ...
          <div className="py-2 inline-block min-w-full lg:px-8 sm:px-2 sm:py-0">
            <div className="overflow-hidden">
              <table className="min-w-full">
                <thead className="">
                  <tr>
                    <th scope="col" className=" px-6 py-4 text-center sm:px-2 sm:text-xs">
                      قیمت
                    </th>
                    <th scope="col" className=" px-6 py-4 text-center sm:px-2 sm:text-xs">
                      تاریخ
                    ...
                    ? requests.data.map((req) =>
                        req.bidder == user.data.id ? (
                          <tr className="border-t">
                            <td className="  font-light px-6 py-4 whitespace-nowrap sm:px-2">{req.fee} ريال</td>
                            <td className="   px-6 py-4 whitespace-nowrap sm:px-2">
                            ...
                            <td className="  font-light px-6 py-4 whitespace-nowrap sm:px-0">
                              <div className="w-full flex justify-center">
                                <BorderButton className="w-1/4 text-center" onClick={() => removeRequest()}>
                                  {/* لغو */}
